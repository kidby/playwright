...
export { androidCapabilities, iosCapabilities, normalizeCapabilities, mergeDeviceIntoCapabilities } from './capabilities.js';
...
export type { AppiumConfig, AppiumDevice, AttachableTestInfo, MobileFixtures, MobileTestArgs, MobileTestOptions } from './mobileTest.js';
