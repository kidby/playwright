...
import { TargetClosedError, parseError } from './errors.js';
...
import type { BrowserContextOptions, Headers, SetStorageState, StorageState, TimeoutOptions, WaitForEventOptions } from './types.js';
