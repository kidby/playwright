...
export const deps: any = {
  ...
  'ubuntu26.04-x64': {
    ...
    lib2package: {
      ...
      'libharfbuzz.so.0': 'libharfbuzz0b',
      'libhyphen.so.0': 'libhyphen0',
      'libicudata.so.78': 'libicu78',
      'libicui18n.so.78': 'libicu78',
      'libicuuc.so.78': 'libicu78',
      'libjpeg.so.8': 'libjpeg-turbo8',
      'liblcms2.so.2': 'liblcms2-2',
      'libmanette-0.2.so.0': 'libmanette-0.2-0',
      'libnspr4.so': 'libnspr4',
...
deps['ubuntu26.04-arm64'] = {
  tools: [...deps['ubuntu26.04-x64'].tools],
  chromium: [...deps['ubuntu26.04-x64'].chromium],
  firefox: [
    ...deps['ubuntu26.04-x64'].firefox,
  ],
  webkit: [
    ...deps['ubuntu26.04-x64'].webkit,
  ],
  lib2package: {
    ...deps['ubuntu26.04-x64'].lib2package,
  },
};
