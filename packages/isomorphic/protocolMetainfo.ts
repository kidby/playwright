...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['AppLocator.wait', { title: 'Wait', }],
  ['AppLocator.click', { title: 'Click', }],
  ['AppLocator.fill', { title: 'Fill', }],
  ['AppLocator.clear', { title: 'Clear', }],
  ['AppLocator.screenshot', { title: 'Screenshot', }],
  ['Appium.connect', { internal: true, }],
  ['AppiumDevice.appLocator', { internal: true, }],
  ['AppiumDevice.screenshot', { title: 'Screenshot', }],
  ['AppiumDevice.request', { internal: true, }],
  ['AppiumDevice.close', { title: 'Close', }],
  ...
  ['Ios.devices', { internal: true, }],
  ['IosDevice.tap', { title: 'Tap', }],
  ['IosDevice.fill', { title: 'Fill "{text}"', }],
  ['IosDevice.screenshot', { title: 'Screenshot', }],
  ['IosDevice.webViews', { internal: true, }],
  ['IosDevice.executeScript', { internal: true, }],
  ['IosDevice.close', { title: 'Close', }],
